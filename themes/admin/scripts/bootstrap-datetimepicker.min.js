    ...
    (function(f, c) {
        ...
        var i = function(l, k) {
            ...
            this.component = this.element.is(".date") ? (this.bootcssVer == 3 ? this.element
                    .find(
                        ".input-group-addon .fa-th, .input-group-addon .fa-time, .input-group-addon .fa-remove, .input-group-addon .fa-calendar, .input-group-addon .fa-calendar, .input-group-addon .fa-clock-o")
                    .parent() :
                    this.element
                    .find(
            ...
            this.componentReset = this.element.is(".date") ? (this.bootcssVer == 3 ? this.element
                    .find(
                        ".input-group-addon .fa-remove, .input-group-addon .fa-times")
                    .parent() :
                    this.element.find(
            ...
            this.icons = {
                leftArrow: this.fontAwesome ? "fa-arrow-left" :
                    (this.bootcssVer === 3 ? "fa-chevron-left" : "fa-chevron-left"),
