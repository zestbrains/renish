...
class paypal_lib {
	...
	function paypal_auto_form() 
	{
		...
		echo "<center><h2 style='color: #3E6832; font-size: 50px; margin-top: 5%;'>Fantastic";
		echo ".</h2></center>\n";	
		echo "<center><img src='".ASSETS_URL."/uploads/241.GIF' /></center>";
		echo "<center style='font-size: 25px;'><br/><br/>Please Wait For While,we are almost there</center>";
