...
<div class="container" style="margin-top: 100px !important;">
   ...
   ?> 
        ...
        <div class="col-sm-12">
           ...
           <div class="review-block" id="commentlisting">
               <?php if($isCommentEdit) { ?>
                 <span id="edit_comment"  title="You can edit your comment untill next <?php echo $remainingDays ?$remainingDays:0; ?>">
           ...
           <div class="" id="shareComment" style="<?php echo $IsdisplayList; ?>">
             <div class="" id="commentlisting">
                 	<p>Share your experience with social medias.
					<div class="fb-share-button" data-href="<?php echo DOMAIN_URL; ?>" data-layout="button_count"></div>
                          <a target="_blank" class="twitter_share" href="http://twitter.com/share?text=<?php echo $CommentData['vComment']!='' ? $CommentData['vComment'] : ''; ?>&amp;url=http://zestbrains.com/repair_surity/shop/detail/2" title="Twitter Share"><img src="<?php echo ASSETS_URL.'/manual/tw.png'; ?>"/></a>                  </p>
    ...
    <!-- <div class="row " id="shareComment" style="<?php echo $IsdisplayList; ?>"> -->
        <!-- <div class="col-sm-12" id="shareComment" style="<?php echo $IsdisplayList; ?>">
             <div class="review-block" id="commentlisting">
                 <div class="row customer-review">
