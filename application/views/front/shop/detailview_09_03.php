      ...
      <div class="col-lg-12 header_container">
         <div class="image_container" style="background-image:url('<?php echo DOMAIN_URL.'/'.$GarageData['vCoverImage']; ?>')">
            <div class="col-lg-12 garage_info">
               <div class="col-lg-1 garage_info_image">
                  <img src="<?php echo DOMAIN_URL.$GarageData['vProfileImage']; ?>"/>
               </div>
               <div class="col-lg-5 garage_info_name">
                  ...
                  <?php
                     $city= $GarageData['vCity'] ? $GarageData['vCity'] : 'city';
                     $state=$GarageData['vState'] ? $GarageData['vState'] : 'state';
                     $country=$GarageData['vCountry'] ? $GarageData['vCountry'] : 'country';
                     ?>
                  <div class="garage_info_location"><span class="location">  <i class="fa fa-map-marker"></i>
                     <?php echo $city.','.$state.','.$country; ?></span>
                  </div>
               </div>
               <div class="col-lg-6">
                  <div class="col-lg-9">
                     <div class="garage_icons">
                        <ul>
                           <li><a href="javascript:;">1<br><span>Total sell</span></a></li>
                           <li><a href="javascript:;">2<br><span>Avg ratting</span></a></li>
                           <li><a href="javascript:;">3<br><span>Total Review</span></a></li>
<!--                           <li><a href="javascript:;"><i class="fa fa-map-marker garage-icon"></i><br><span>Review</span></a></li>-->
                  ...
                  <div class="col-lg-3 book-now-container">
                     <?php if($GarageData['iPercentage']!='0'){ ?>
                            <h3>
                               <?php echo $GarageData['iPercentage'] ? $GarageData['iPercentage'] : '0' ; ?>% Discount <br><span>on upto <?php echo $GarageData['vAmountForCoupon'] ? $GarageData['vAmountForCoupon'] : '0' ; ?>$</span>
                           </h3>                     
                            <div class="book-now-btn">
                               <a href="<?php echo DOMAIN_URL; ?>/order/summary/<?php echo $iGarageId; ?>" class="btn btn-primary">Buy Coupon</a>
                            </div>
                     <?php } else { ?>
                            <h3>No Discount</h3>
                            <div class="book-now-btn">
...
<div class="container">
   <div class="row">
               ...
               <div class="col-lg-12 about-garage">
                  <ul>
                     <?php
                        ...
                        ?>
                     <li><i class="fa fa-phone"></i><span>Shop Type:</span><div class="break-l"><?php echo $garageType; ?><div></li>
                     <li><i class="fa fa-phone"></i><span>Address:</span><div class="break-l"><?php echo $GarageData['vAddress'] ? $GarageData['vAddress'] : '-' ; ?>.</div></li>
                     <li><i class="fa fa-phone"></i><span>Total Mechanic:</span><?php echo $GarageData['iTotalMechanic'] ? $GarageData['iTotalMechanic'] : 0 ; ?></li>
                     <li><i class="fa fa-phone"></i><span>Zip Code:</span><?php echo $GarageData['vZipCode'] ? $GarageData['vZipCode'] : '-' ; ?></li>
                     <li><i class="fa fa-phone"></i><span>Mobile:</span><?php echo $GarageData['vMobile'] ? $GarageData['vMobile'] : '-' ; ?></li>
            ...
            <div class="panel-body">
               ...
               <div class="col-lg-12 about-garage">
                  <ul>
                       ...
                       <?php if($GarageData['iPercentage']!='0'){ ?>
                            <li class="depend"><b><?php echo $GarageData['iPercentage'] ? $GarageData['iPercentage'] : '0' ; ?>% Discount on upto <?php echo $GarageData['vAmountForCoupon'] ? $GarageData['vAmountForCoupon'] : '0' ; ?>$</b></li>
                            <li class="depend"><b>Coupon price <?php echo $GarageData['vCoupenPrice'] ? $GarageData['vCoupenPrice'] : '0' ; ?>$</b></li>
                       <?php } else { ?>
                            <li class="depend"><b>No Discount</b></li>
                             <li class="depend"><b>Coupon price <?php echo $GarageData['vCoupenPrice'] ? $GarageData['vCoupenPrice'] : '0' ; ?>$</b></li>
                       <?php } ?>     
      ...
      <div class="col-lg-12 detail_container1">
         <div class="panel panel-default">
            <div class="panel-heading profile-small-title">
               <h3>Detail:</h3>
            </div>
            <div class="panel-body">
               <div class="col-lg-8 working-days working-days col-xs-offset-2">
                    ...
                    <div class="isotope-grid gallery-container style-column-3">
                        ...
                        ?>   
                            <div class="isotope-item">
                               <a href="javascript:;" class="thumb-overlay" data-rel="lightcase:gallery1">
                               <img src="<?php echo DOMAIN_URL.'/'.$GarageImages[$i]['vImage']; ?>" alt="Gagrage Photo"/>
                               </a>
                            </div>
                        <?php } }else{ ?>
      ...
      <div class="col-lg-12 location_container">
         <div class="panel panel-default">
            <div class="panel-heading profile-small-title">
               <h3>Location:</h3>
            </div>
      ...
      <div class="col-lg-12 detail-review">
         <div class="panel panel-default">
            <div class="panel-heading profile-small-title">
               <h3>Reviews:</h3>
            </div>
           <?php  if($comment_count>0){ ?>  
                    <div class="panel-body">
                       ...
                       <div class="col-sm-4 avrage-ratings">
                          ...
                          <div class="pull-left">
                             ...
                             <div class="pull-left" style="width:180px;">
                                <div class="progress" style="height:9px; margin:8px 0;">
                                   <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
