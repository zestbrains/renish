...
<!-- PAGEBODY -->
<div class="forightmap col-sm-8 col-md-8 col-lg-8 col-xs-12" style="margin-top: 100px !important;">
  <div class="row ">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if ($.trim(data)!='') {
                            ...
                            $("#loading-image").hide();
                            if(search!=''){
                                $("#listing").html('<h4 class="depend"><strong>Sorry, but we were unable to find the zipcode or name <b>'+search+'</b></strong></h4>'+'Please make sure you entered everything correctly and if so, try to finding in our all data by '+'<a href="<?php echo DOMAIN_URL; ?>/shop/lists/<?php echo $page_type; ?>">Clicking here</a>');
                            }else{
                                var discountText=$("#vCouponDiscount option:selected").text();
                                $("#listing").html('<h4 class="depend"><strong>Sorry, but we were unable to find the discount <b>'+discountText+'</b></strong></h4>'+'Please make sure you entered everything correctly and if so, try to finding in our all data by '+'<a href="<?php echo DOMAIN_URL; ?>/shop/lists/<?php echo $page_type; ?>">Clicking here</a>');
                            }    
                        }
                    },
                    error: function (e) {
...
$(function(){
   ...
   $(window).resize(function() {
      ...
      $('.forlistmapp #map').css({"height":wheight+"px"});
    });
