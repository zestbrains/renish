  ...
  <div class="row ">
    <div class="panel panel-default unqlistsearch">
      ...
      <div class="col-lg-12 filter_container_main" id="filter_container_main">
        <form name="zipsearchForm" id="zipsearchForm">  
        <div class="row">
          <div class="col-sm-5 col-md-5 col-lg-5 col-xs-12">
            <input type="text" name="search" id="search" class="form-control profile-field" placeholder="Search by zipcode or name" tabindex="2" value="<?php echo $search ? $search : '' ?>" maxlength="5">
          </div>
          <div class="col-sm-5 col-md-5 col-lg-5 col-xs-12">
 ...
 $(document).ready(function(){
   $("body").on('click', "#apply_filter", function (e) {
                ...
                $("#zipsearchForm").validate({
                    ...
                    messages: {
                      search:{digits:"Enter only digits"}
                    },
