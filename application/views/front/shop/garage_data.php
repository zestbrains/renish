...
<li class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
  <div class="listing-item">
    ...
    <div class="col-lg-2 listing-image-block"> <a href="#"><img src="<?php echo $GarageData[$i]['vProfileImage'] ? DOMAIN_URL.$GarageData[$i]['vProfileImage'] :''; ?>" width="100%" height="100" class="user-image"></a> </div>
    <div class="col-lg-10 listing-image-block">
      <div class="review-block-rate-2"> <span class="star-reviews-customer">
        <?php
                         $star='';
                         for($k=1;$k<=5;$k++){
      ...
      <span><?php echo ($GarageData[$i]['iPercentage']!='' && $GarageData[$i]['iPercentage']!=0) ? $GarageData[$i]['iPercentage'].' %'.' discount upto '.$GarageData[$i]['vAmountForCoupon'].'$' :'No discount'; ?></span> </div><div style="clear:both"></div>
  </div>
</li>
<?php } ?>
