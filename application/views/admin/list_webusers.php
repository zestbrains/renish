			...
			<div class="col-md-12">
					...
					<div class="portlet light portlet-toggler">
						<div class="portlet-title">
							...
							<div class="actions">
                <a href="javascript:void(0);" data-id="0" title="Add Web-User" class="btn btn-circle btn-default btnEdit" data-type="form" data-url="<?php echo base_url(ADM_URL . strtolower($class)); ?>">
...
<script type="text/javascript">
  $(document).ready(function() {
    oTable = $('#listResults').DataTable( {
        ...
        "serverSide": true,
        "order": [[ 1, "ASC" ]],
        "ajax": "<?php echo base_url(ADM_URL . 'users/lists'); ?>",
        "columns": [
